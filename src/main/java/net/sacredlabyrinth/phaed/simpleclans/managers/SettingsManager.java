...
public final class SettingsManager {
    ...
    public enum ConfigField {
        ...
        ECONOMY_MAX_MEMBER_FEE("economy.max-member-fee", 200.0), ECONOMY_UPKEEP("economy.upkeep", false),
        ...
        TASKS_COLLECT_FEE_HOUR("tasks.collect-fee.hour", 1), TASKS_COLLECT_FEE_MINUTE("tasks.collect-fee.minute", 0),
        /*
         * ================ > Page Settings ================
         */
