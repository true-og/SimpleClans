...
public final class PermissionsManager {
    ...
    public void savePermissions() {
        ...
        for (Clan clan : plugin.getClanManager().getClans()) {
            ...
            if (permissions.containsKey(clan.getTag())) {
                ...
                SimpleClans.getInstance().getSettingsManager().getConfig().set("permissions." + clan.getTag(),
                        getPermissions(clan));
     ...
     *
     * @deprecated use
     *             {@link PermissionsManager#chargePlayer(OfflinePlayer, double)}
     *             instead
     */
    @Deprecated
    ...
    public boolean chargePlayer(@NotNull OfflinePlayer player, double money, @Nullable Cause cause) {
        ...
        EconomyResponse response = Objects.requireNonNull(economy, "Can't find economy provider").withdrawPlayer(player,
                money);
        ...
        EconomyTransactionEvent event = new EconomyTransactionEvent(player, money, cause,
     ...
     *
     * @deprecated use {@link PermissionsManager#grantPlayer(OfflinePlayer, double)}
     *             instead
     */
    @Deprecated
    ...
    public boolean grantPlayer(@NotNull OfflinePlayer player, double money, @Nullable Cause cause) {
        ...
        EconomyResponse response = Objects.requireNonNull(economy, "Can't find economy provider").depositPlayer(player,
                money);
        if (!response.transactionSuccess()) {
        ...
        EconomyTransactionEvent event = new EconomyTransactionEvent(player, response.amount, cause,
