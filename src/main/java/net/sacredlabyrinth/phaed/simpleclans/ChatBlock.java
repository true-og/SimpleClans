...
public class ChatBlock {
    ...
    private static double msgLength(String str) {
        ...
        // Loop through all the characters, skipping any color characters and their
    ...
    private static String[] wordWrap(String msg) {
        ...
        while (!split.isEmpty()) {
            ...
            // go through the split array containing all the words, and adding them to the
            // words array
            ...
            // Merge the words into a sentence (that now fits into a single chat line) and
