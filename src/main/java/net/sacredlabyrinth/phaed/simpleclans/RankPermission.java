...
public enum RankPermission {
    ...
    FEE_SET("simpleclans.leader.fee", PermissionLevel.LEADER), FEE_BYPASS("", PermissionLevel.LEADER),
    ...
    KICK("simpleclans.leader.kick", PermissionLevel.LEADER), COLOR("simpleclans.leader.color", PermissionLevel.LEADER),
