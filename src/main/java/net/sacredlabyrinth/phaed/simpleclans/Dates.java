...
public class Dates {
     ...
     * @param depth   Max amount of detail (e.g. only display days and hours if set
     *                to 1 and seconds {@literal >} 1 day)
     * @return the string representation of the amount of time labeled as days,
