 ...
 * <p>
 * Note: Cancelling this event will deny the transaction.
 * </p>
 *
...
public class EconomyTransactionEvent extends Event implements Cancellable {
    ...
    public EconomyTransactionEvent(@NotNull OfflinePlayer affected, double amount, @NotNull Cause cause,
    ...
    public enum Cause {
        ...
        DISCORD_CREATION, PLAYER_KILLED, MEMBER_FEE_SET, RESET_KDR
    }
