...
public class ClanDetailsFrame extends SCFrame {
    ...
    private SCComponent createChatComponent(boolean clanEnabled, boolean allyEnabled) {
        ...
        return new SCComponentImpl(lang("gui.clandetails.chat.title", getViewer()),
                Arrays.asList(lang("gui.clandetails.chat.clan.chat.lore", getViewer(), chatCommand),
                        ...
                        lang("gui.clandetails.chat.ally.join.leave.lore", getViewer(),
    ...
    private void addRank() {
        ...
        SCComponent rank = new SCComponentImpl(lang("gui.clandetails.rank.title", getViewer()),
                Collections.singletonList(lang("gui.clandetails.rank.lore", getViewer())), XMaterial.IRON_HELMET, 37);
    ...
    private void addFee() {
        ...
        String status = clan.isMemberFeeEnabled() ? lang("fee.enabled", getViewer())
                : lang("fee.disabled", getViewer());
    ...
    private void addDisband() {
        ...
        SCComponent disband = new SCComponentImpl(lang("gui.clandetails.disband.title", getViewer()),
                Collections.singletonList(lang("gui.clandetails.disband.lore", getViewer())), XMaterial.BARRIER, 50);
    ...
    private void addRegroup() {
        ...
        if (price != 0)
            lore.add(lang("gui.clandetails.regroup.lore.price", getViewer(), CurrencyFormat.format(price)));
    ...
    private void addHome() {
        ...
        List<String> lore = new ArrayList<>();
        if (homePrice != 0)
            lore.add(lang("gui.clandetails.home.lore.teleport.price", getViewer(), CurrencyFormat.format(homePrice)));
        lore.add(lang("gui.clandetails.home.lore.teleport", getViewer()));
        if (setPrice != 0)
            lore.add(lang("gui.clandetails.home.lore.set.price", getViewer(), CurrencyFormat.format(setPrice)));
    ...
    private void addRoster() {
        ...
        SCComponent roster = new SCComponentImpl(lang("gui.clandetails.roster.title", getViewer()),
                Collections.singletonList(lang("gui.clandetails.roster.lore", getViewer())), XMaterial.PLAYER_HEAD, 19);
    ...
    private void addAllies() {
        ...
        SCComponent allies = new SCComponentImpl(lang("gui.clandetails.allies.title", getViewer()),
                Collections.singletonList(lang("gui.clandetails.allies.lore", getViewer())), XMaterial.CYAN_BANNER, 23);
    ...
    private void addRivals() {
        ...
        SCComponent rivals = new SCComponentImpl(lang("gui.clandetails.rivals.title", getViewer()),
                Collections.singletonList(lang("gui.clandetails.rivals.lore", getViewer())), XMaterial.RED_BANNER, 25);
    ...
    public @NotNull String getTitle() {
        ...
        return lang("gui.clandetails.title", getViewer(), ChatUtils.stripColors(clan.getColorTag()), clan.getName());
