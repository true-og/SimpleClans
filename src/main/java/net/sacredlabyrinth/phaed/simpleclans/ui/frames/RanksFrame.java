    ...
    public void createComponents() {
        ...
        for (int i = paginator.getMinIndex(); paginator.isValidIndex(i); i++) {
            ...
            if (toEdit != null) {
                ...
                c.setListener(ClickType.LEFT, () -> InventoryController.runSubcommand(getViewer(), "rank assign", true,
                        toEdit.getName(), rank.getName()));
                ...
                c.setListener(ClickType.LEFT,
                        () -> InventoryDrawer.open(new PermissionsFrame(this, getViewer(), rank)));
                c.setPermission(ClickType.LEFT, "simpleclans.leader.rank.permissions.list");
                c.setListener(ClickType.RIGHT,
                        () -> InventoryController.runSubcommand(getViewer(), "rank delete", true, rank.getName()));
